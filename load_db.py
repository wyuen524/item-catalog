...
class1 = Weapon(name="Assault Rifle")
...
item1 = ItemInfo(name="M4",
                 ...
                 damage="32", dps="181.5", weapon=class1)

session.add(item1)
session.commit()

class2 = Weapon(name="Shotgun")
...
item2 = ItemInfo(name="Pump",
                 ...
                 damage="85", dps="59.5", weapon=class2)

session.add(item2)
session.commit()

class3 = Weapon(name="Submachine Gun")
...
item3 = ItemInfo(name="P90",
                 ...
                 damage="20", dps="200", weapon=class3)

session.add(item3)
session.commit()

class4 = Weapon(name="Sniper Rifle")
...
item4 = ItemInfo(name="Hunting Rifle",
                 ...
                 damage="90", dps="225", weapon=class4)

session.add(item4)
session.commit()

class5 = Weapon(name="Explosives")
...
item5 = ItemInfo(name="Rocket Launcher",
                 ...
                 "enemy buildings",
                 damage="110", dps="82.5", weapon=class5)
